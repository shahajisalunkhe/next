...
const Home = () => {
        ...
        const fetchCategoriesData = async () => {
            try {
                ...
                if (data.success && data.categories) {
                    console.log("[Category Debug] Fetched Categories Data:", data.categories);
    ...
    return (
        <div className="bg-white">
            ...
            {/* 
                 SECTION 1.5: PREMIUM BLACK ANNOUNCEMENT BAR (MARQUEE)
             */}
                            ...
                            >
                                <Link href={`/collections/${cat.slug}`} className="category-card block group">
                                    <div className={`aspect-[4/5] bg-gray-200 relative overflow-hidden rounded-none animate-pulse`}>
                                        ...
                                        />
                                        {/* Category Name Overlay - Minimal Label at bottom */}
